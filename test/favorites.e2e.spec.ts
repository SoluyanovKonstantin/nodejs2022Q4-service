...
describe('Favorites (e2e)', () => {
    ...
    describe('GET (advanced)', () => {
        it('should correctly get all favorites entities', async () => {
            ...
            expect(addTrackToFavoritesResponse.status).toBe(
                StatusCodes.CREATED,
            );
            ...
            expect(addAlbumToFavoritesResponse.status).toBe(
                StatusCodes.CREATED,
            );
    ...
    describe('POST', () => {
        ...
        it('should respond with UNPROCESSABLE_ENTITY in case of entity absence', async () => {
            ...
            expect(artistsResponse.status).toBe(
            ...
            expect(albumsResponse.status).toBe(
                StatusCodes.UNPROCESSABLE_ENTITY,
            );
            ...
            expect(tracksResponse.status).toBe(
                StatusCodes.UNPROCESSABLE_ENTITY,
            );
        });
    });
    ...
    describe('DELETE', () => {
        ...
        it("should respond with NOT_FOUND status code in case if entity doesn't exist", async () => {
            const albumsDeletionFromFavoritesResponse =
            ...
            const artistsDeletionFromFavoritesResponse =
                await unauthorizedRequest
            ...
            const tracksDeletionFromFavoritesResponse =
                await unauthorizedRequest
